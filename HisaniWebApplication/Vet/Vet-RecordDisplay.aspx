<%@ Page Title="" Language="C#" MasterPageFile="~/Vet/Vet.Master" AutoEventWireup="true" CodeBehind="Vet-RecordDisplay.aspx.cs" Inherits="HisaniWebApplication.Vet.Vet_RecordDisplay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="vet-record-table-container">
        <h2>
            Vet Records
            <a href="Vet-RecordAdd.aspx" class="add-record-btn">Add Record</a> <!-- Add Record button -->
        </h2>
