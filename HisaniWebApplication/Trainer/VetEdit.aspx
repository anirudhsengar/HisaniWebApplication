...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="add-vet-container">
        ...
        <form method="post" action="VetEdit.aspx">
            <div class="form-group">
                ...
                <asp:TextBox ID="vetEmailText" runat="server" CssClass="form-control" placeholder="Enter vet email" type="email" Enabled="false" />
            </div>
            <div class="form-group">
    ...
    <script>
        function validateForm() {
            let vetEmail = document.getElementById('<%= vetEmailText.ClientID %>').value.trim();
