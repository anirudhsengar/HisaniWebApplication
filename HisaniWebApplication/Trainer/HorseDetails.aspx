...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="horse-details-container">
        ...
        <div class="button-container">
            <!-- Edit Button -->
            <asp:Button ID="btnEditHorse" runat="server" CssClass="btn edit-btn" 
                        Text="Edit Horse" OnClick="btnEditHorse_Click" />

            <!-- Delete Button -->
            <asp:Button ID="btnDeleteHorse" runat="server" CssClass="btn delete-btn" 
                        Text="Delete Horse" OnClick="btnDeleteHorse_Click" 
                        OnClientClick="return confirm('Are you sure you want to delete this horse?');" />
        </div>
